...
<nav class="navbar">
  ...
  <li class="navbar__list" style="padding-left: 30px;"><a href="formule.php" id="demande">Aceuil</a></li>
    <li class="navbar__list" style="padding-left: 30px;"><a href="" id="demande">demandes de congé</a></li>
    <li class="navbar__list" style="padding-left: 40px;"><a href="voirconge.php" id="demande">Voir un demande</a></li>
    <li class="navbar__list" style="padding-left: 30px;"><a href="formule.php" id="demande">Oranigramme</a></li>
    ...
    <form class="formule" action="" method="POST">
      <div class="parent section  ">
        ...
        <div class="parent__children">
          ...
          <input class="parent__input" type="date" name="date_debut" placeholder="date_début" value="<?php echo isset($_POST['date_début']) ? $_POST['date_début'] : ''; ?>">
        </div>
        ...
        <div class="parent__children">
          ...
          <input class="parent__input" type="number" name="duree" placeholder="Entrer le durée" value="<?php echo isset($_POST['durée']) ? $_POST['durée'] : ''; ?>">
        </div>
